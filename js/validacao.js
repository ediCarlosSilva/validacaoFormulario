...
// Regras para validar cpf
// 123 456 789 09

// let soma = (10 * 1) + (9 * 2) + (8 * 3) ... (2 * 9)

// let primeiroDigiVerificador = 11 - (soma % 11)

// let somaParaSegundoDigito = (11 * 1) + (10 * 2) + (9 * 3) ... (2 * 0)

// let segundoDigiVerificador = 11 - (soma % 11)
...
function preencherCamposCEP(data) {
    ...
    const uf = document.querySelector('[data-tipo="estado"]');
